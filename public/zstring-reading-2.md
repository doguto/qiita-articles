...
tags:
  ...
  - OSS
private: false
updated_at: '2025-10-19T23:45:08+09:00'
...
　またVScodeの環境構築が面倒なため、私はC#を書くときには基本的にRiderを使用しています。非商用利用は無料ですからね。
...
　他にも引数の数が1個から16個までのまでのバージョンを用意していたりするため、実装の楽のために用意されたのだと予想できます。（引数の数や型が違うだけの関数を沢山実装するのは苦痛なだけですからね…）
